                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    {!! 'Qt: '.$shopcartlist->quantity.' x '.$shopcartlist['product']->name !!}
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>$</span>{!! $shopcartlist['product']->price !!}</h6>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><?php if( isset($shopcart_sum) ){ echo '$'.$shopcart_sum; } else echo '$0.00' ?></div>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-xs-12">
                                    <strong>Name:</strong>
                                    <input type="text" value="{{ Auth::user()->name }}" name="last_name" class="form-control" value="" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="zip_code" class="form-control" value="{{ Auth::user()->cep }}" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>State:</strong></div>
                                <div class="col-md-12">
                                    <input type="text" name="state" class="form-control" value="{{ Auth::user()->estate }}" />
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="" id="exp1">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <select class="form-control" name="" id="exp2">
